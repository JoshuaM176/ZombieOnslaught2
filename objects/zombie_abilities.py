...
def spawn_zombie(self, _, spawn_zombie, count):
    for i in range(count):
        event_bus.add_event("game_event_bus", {"spawn_zombie": {"x": self.x, "y": self.y, "round": 0, "zombie": spawn_zombie }})

def initial_velocity(self, frame_time, x_vel, y_vel, decay): # velocity formula is velocity*decay^seconds_passed
